...
vim.keymap.set(
	...
	{ desc = "Toggle debugger & continue to breakpoint" }
) -- start debugger
...
vim.keymap.set("n", "<leader>dn", ":lua require'dap'.step_over()<CR>", { desc = "Debug | Step Over | Next line" })
...
-- jj -> <Esc>
vim.keymap.set("i", "jj", "<Esc>", { remap = true, desc = "double j to escape" })

-- window management
vim.keymap.set("n", "<leader>q", "<cmd>bd<cr>", { remap = false, desc = "Close buffer softly" })
vim.keymap.set("n", "<leader>wK", "<cmd>resize +12<cr>", { remap = false, desc = "Increase buffer size height" })
vim.keymap.set("n", "<leader>wJ", "<cmd>resize -12<cr>", { remap = false, desc = "Decrease buffer size height" })
vim.keymap.set("n", "<leader>wk", "<cmd>resize +12<cr>", { remap = false, desc = "Increase buffer size width" })
vim.keymap.set("n", "<leader>wj", "<cmd>resize -12<cr>", { remap = false, desc = "Decrease buffer size width" })
...
end, { remap = true, silent = true, desc = "Fold-cycle: toggle folds" })

-- symbols outline
vim.keymap.set("n", "<C-y>", "<cmd>SymbolsOutline<cr>", { remap = true, silent = true, desc = "Toggle SymbolsOutline" })
...
vim.keymap.set("n", "<leader>ff", "<cmd>Telescope find_files<cr>", { remap = false, desc = "Telescope grep files" })
vim.keymap.set("n", "<leader>fk", "<cmd>Telescope keymaps<cr>", { remap = false, desc = "Telescope Keymaps" })
vim.keymap.set("n", "<leader>fh", "<cmd>Telescope help_tags<cr>", { remap = false, desc = "Telescope search for help" })
vim.keymap.set(
	"n",
	"<leader>fb",
...
-- neogit
vim.keymap.set("n", "<leader>ng", "<cmd>Neogit<cr>", { remap = false, silent = true, desc = "Start Neogit" })
...
-- database
vim.keymap.set("n", "<leader>DB", "<cmd>DBUIToggle<cr>", { remap = false, silent = true, desc = "Toggle Database UI" })
